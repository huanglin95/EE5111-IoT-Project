...
PRIVATE_KEY = "bed5504234-private.pem.key"

# The relative path to your certificate file that
# &IoT; generated for this device, which you
# have already saved onto this device.
CERT_FILE = "bed5504234-certificate.pem.crt"

# A programmatic shadow handler name prefix.
SHADOW_HANDLER = "Thing1_A0206810R"
...
FD001_data = open("train_FD001.txt")
for row in FD001_data:
    ...
    NewData.append('FD001_' + DataList[0])
